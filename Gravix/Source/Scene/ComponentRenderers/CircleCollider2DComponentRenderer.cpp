#include "pch.h"
#include "CircleCollider2DComponentRenderer.h"
...
namespace Gravix
{
	...
	void CircleCollider2DComponentRenderer::Register()
	{
		ComponentRegistry::Get().RegisterComponent<CircleCollider2DComponent>(
			"CircleCollider2D",
...
#ifdef GRAVIX_EDITOR_BUILD
	void CircleCollider2DComponentRenderer::Serialize(YAML::Emitter& out, CircleCollider2DComponent& c)
	{
	...
	void CircleCollider2DComponentRenderer::Deserialize(CircleCollider2DComponent& c, const YAML::Node& node)
	{
	...
	void CircleCollider2DComponentRenderer::OnImGuiRender(CircleCollider2DComponent& c, ComponentUserSettings*)
	{
		// Offset property
	...
	void CircleCollider2DComponentRenderer::BinarySerialize(BinarySerializer& serializer, CircleCollider2DComponent& c)
	{
	...
	void CircleCollider2DComponentRenderer::BinaryDeserialize(BinaryDeserializer& deserializer, CircleCollider2DComponent& c)
	{
